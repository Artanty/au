  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        ...
        './UserAvatarComponent': './src/app/auth/components/_remotes/user-avatar/user-avatar.component.ts',
        
        
        './UserAvatarRemoteFunc': './src/app/auth/components/_remotes/user-avatar/user-avatar-remote-func.ts', // good
        './UserAvatarModule': './src/app/auth/components/_remotes/user-avatar/user-avatar.module.ts',
